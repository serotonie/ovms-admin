...
<template>
  ...
  <AuthenticatedLayout>
          ...
          <v-row>
            ...
            <v-col cols="12" sm="12" md="6">              
              <v-text-field
                ...
                @click:append-inner="form.module_id=nanoid(12)"
                label="Module ID"
                variant="underlined"
            ...
            <v-col cols="12" sm="12" md="6">              
              <v-text-field
                v-model="form.module_username"
                append-inner-icon="mdi-reload"
                @click:append-inner="form.module_username=nanoid(12)"
    ...
    <v-dialog
      v-model="creation_success_dialog"
      persistent
      width="600"
    >
      ...
      <v-alert
        title="Help us developping this app"
        type="info"
        icon="mdi-github"
      >
        Add a direct config via HTTP API
        <a
          href="https://docs.openvehicles.com/en/latest/userguide/commands.html#module-http-server"
        >
          Starting point
        </a>
      </v-alert>
